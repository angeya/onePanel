<template>
  <el-dialog v-model="visible" title="导入应用" width="500px" :close-on-click-modal="false">
    <el-tabs v-model="activeTab">
      <el-tab-pane label="从 zip 文件导入" name="zip">
        <el-form label-width="90px">
          <el-form-item label="zip 文件" required>
            <div style="display: flex; gap: 8px; width: 100%">
              <el-input v-model="zipPath" placeholder="选择 zip 文件或手动输入路径" />
      ...
      <el-tab-pane label="从目录导入" name="dir">
        <el-form label-width="90px">
          <el-form-item label="应用目录" required>
            <div style="display: flex; gap: 8px; width: 100%">
          ...
          <el-form-item label="应用名称">
            <el-input v-model="dirName" placeholder="为空则使用目录名称" />
          </el-form-item>
        </el-form>
        <div style="text-align: right">
      ...
      <el-tab-pane label="从 html 文件导入" name="html">
        <el-form label-width="90px">
          ...
          <el-form-item label="应用名称" required>
            <el-input v-model="htmlName" placeholder="应用名称"/>
          </el-form-item>
        </el-form>
        <div style="text-align: right">
